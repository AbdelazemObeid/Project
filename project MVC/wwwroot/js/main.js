...
(function() {
    ...
    function initBannerSlider() {
        ...
        items.forEach(function (item, i) {
            ...
            wrapper.appendChild(item);   // بدل cloneNode(true)
        });

        slider.innerHTML = '';
        slider.appendChild(wrapper);

        // إعادة تعيين صور الخلفية
        initSetBackground();
    ...
    function initPriceRange() {
        ...
        var minVal = parseInt(rangeSlider.dataset.minVal, 10) || minPrice;
        var maxVal = parseInt(rangeSlider.dataset.maxVal, 10) || maxPrice;
        ...
        rangeSlider.innerHTML =
            ...
            '<input type="range" class="price-range__input price-range__input--min" min="' + minPrice + '" max="' + maxPrice + '" value="' + minVal + '">' +
            '<input type="range" class="price-range__input price-range__input--max" min="' + minPrice + '" max="' + maxPrice + '" value="' + maxVal + '">';
