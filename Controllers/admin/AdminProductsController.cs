    ...
    public class AdminProductsController : Controller
    {
        ...
        public IActionResult Create(Product product)
        {
            try
            {
                ...
                if (user == null) {
                    user = new User { UserName = "Admin", Email = "admin@test.com", PasswordHash = "123", Role = "Admin" };
                ...
                // Fix: Convert Guid to int (if user_id is int, you need to store a valid int, not a Guid)
                product.user_id = 0; // or another valid int user id, depending on your logic
